...
<style scoped>
.login-page { display: flex; flex-direction: column; align-items: center; padding: 60px 16px 0; min-height: 100vh; background: linear-gradient(180deg, #f0fff4 0%, #f5f5f7 100%); }
...
.form { width: 100%; max-width: 360px; display: flex; flex-direction: column; gap: 14px; padding: 24px; background: #fff; border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.06); }
.form input { padding: 14px 16px; border: 1.5px solid #eee; border-radius: 12px; font-size: 15px; outline: none; transition: border-color 0.2s; background: #fafafa; width: 100%; box-sizing: border-box; }
